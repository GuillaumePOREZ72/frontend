...
export default function Home() {
  ...
  const addTransaction = async () => {
    if (!text || amount == "" || isNaN(Number(amount))) {
      toast.error("Merci de remplir texte et montant valide");
      return;
    }
    setLoading(true);
    ...
    <div className="w-2/3 flex flex-col gap-4">
      <div className="text-center mb-12">
        ...
        <p className="text-base-content/70">
          Suivez vos revenus et dépenses facilement
        </p>
      </div>
      ...
      <dialog id="my_modal" className="modal backdrop-blur">
        <div className="modal-box border-2 border-warning/10 border-dashed rounded-xl">
          <form method="dialog">
          ...
          <div className="flex flex-col gap-4 mt-4">
            <div className="flex flex-col gap-2">
              <label htmlFor="label">Texte</label>
              <input
                type="text"
                name="text"
                value={text}
